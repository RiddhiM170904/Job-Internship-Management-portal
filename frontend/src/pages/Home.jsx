        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-primary-100">
              Connect with top companies and kick-start your career journey
            </p>
            <div className="flex justify-center gap-4">
              ...
              {!isAuthenticated() && (
                <Link to="/signup" className="bg-primary-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary-400 transition border-2 border-white">
                  Get Started
                </Link>
              )}
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Apply to jobs from trusted and verified companies</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Simple and fast application process</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of job seekers finding their perfect opportunity
          </p>
